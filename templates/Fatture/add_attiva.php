...
<div class="fatture form content form-content">
    <div class="page-header">
        <h3><?= __('Nuova Fattura Attiva (Emessa)') ?></h3>
    ...
    <?= $this->Form->hidden('direzione', ['value' => 'emessa']) ?>
    <?php
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            Dati Documento
            <span class="badge bg-success ms-2">Fattura Emessa</span>
        </div>
        <div class="form-card-body">
            ...
            <div class="form-row">
                <div class="form-col-third">
                    <?= $this->Form->control('numero', ['label' => ['text' => 'Numero', 'class' => 'required'], 'placeholder' => '1/A']) ?>
                </div>
                <div class="form-col-third">
            ...
            <div class="form-row">
                <div class="form-col">
                    <?= $this->Form->control('anagrafica_id', ['options' => $anagrafiche, 'empty' => '-- Seleziona cliente --', 'label' => ['text' => 'Cliente', 'class' => 'required']]) ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="form-row">
                <div class="form-col">
                    <?= $this->Form->control('iban', ['label' => 'IBAN', 'placeholder' => 'IT...']) ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-actions">
                <div class="btn-group-left">
                    <?= $this->Html->link(__('Annulla'), ['action' => 'indexAttive'], ['class' => 'btn btn-secondary']) ?>
                </div>
