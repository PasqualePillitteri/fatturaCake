...
<div class="fatture index content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0"><?= __('Fatture Attive (Emesse)') ?></h3>
        <?= $this->Html->link(
            '<i data-lucide="plus" style="width:16px;height:16px;"></i> ' . __('Nuova Fattura Attiva'),
            ['action' => 'addAttiva'],
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-8 d-flex align-items-end gap-2">
                        ...
                        <?= $this->Html->link('<i data-lucide="x" style="width:14px;height:14px;"></i> Reset', ['action' => 'indexAttive'], [
    ...
    <div class="table-toolbar">
        <div class="toolbar-left">
            <button type="button" class="btn-toolbar btn-outline-secondary" data-toggle-table="fatture-attive-table" title="Mostra tutte le colonne">
        ...
        <div class="toolbar-right">
            <div class="table-meta">
                <span class="meta-item">
                    <i data-lucide="file-output" style="width:14px;height:14px;"></i>
                    <?= $this->Paginator->param('count') ?> fatture emesse
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table data-table-id="fatture-attive-table">
            <thead>
                <tr>
                    <th><?= $this->Paginator->sort('tipo_documento', 'Tipo') ?></th>
                    <th><?= $this->Paginator->sort('anagrafica_id', 'Cliente') ?></th>
