    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="form-row">
                ...
                <div class="form-col-half">
                    <?= $this->Form->control('direzione', ['type' => 'select', 'options' => $direzioni, 'label' => 'Direzione', 'default' => 'emessa']) ?>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-col">
                    <?= $this->Form->control('anagrafica_id', ['options' => $anagrafiche, 'empty' => '-- Seleziona cliente/fornitore --', 'label' => ['text' => 'Cliente/Fornitore', 'class' => 'required']]) ?>
                </div>
            </div>
        </div>
    </div>
