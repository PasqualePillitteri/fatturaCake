 ...
 */
$hiddenCount = 19; // colonne nascoste
?>
<div class="anagrafiche index content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0"><?= __('Anagrafiche') ?></h3>
        <?= $this->Html->link(
            '<i data-lucide="plus" style="width:16px;height:16px;"></i> ' . __('Nuova Anagrafica'),
            ['action' => 'add'],
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <?= $this->Form->control('tipo', [
                            'label' => 'Tipo',
                            'options' => ['cliente' => 'Cliente', 'fornitore' => 'Fornitore', 'entrambi' => 'Entrambi'],
                            'empty' => 'Tutti',
    ...
    <div class="table-toolbar">
        <div class="toolbar-left">
            <button type="button" class="btn-toolbar btn-outline-secondary" data-toggle-table="anagrafiche-table" title="Mostra tutte le colonne">
    ...
    <div class="table-responsive">
        <table data-table-id="anagrafiche-table">
            <thead>
                <tr>
                    ...
                    <th class="col-hidden"><?= $this->Paginator->sort('email') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-hidden"><?= $anagrafica->hasValue('tenant') ? h($anagrafica->tenant->nome) : '' ?></td>
                    ...
                    <td class="col-hidden"><?= h($anagrafica->email) ?></td>
                    ...
                    <td class="col-hidden"><?= $anagrafica->deleted ? $anagrafica->deleted->format('d/m/Y H:i') : '-' ?></td>
                    <td class="actions">
