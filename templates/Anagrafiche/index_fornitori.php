...
<div class="anagrafiche index content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0"><?= __('Fornitori') ?></h3>
        <?= $this->Html->link(
            '<i data-lucide="plus" style="width:16px;height:16px;"></i> ' . __('Nuovo Fornitore'),
            ['action' => 'addFornitore'],
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-7 d-flex align-items-end gap-2">
                        ...
                        <?= $this->Html->link('<i data-lucide="x" style="width:14px;height:14px;"></i> Reset', ['action' => 'indexFornitori'], [
    ...
    <div class="table-toolbar">
        <div class="toolbar-left">
            <button type="button" class="btn-toolbar btn-outline-secondary" data-toggle-table="fornitori-table" title="Mostra tutte le colonne">
        ...
        <div class="toolbar-right">
            <div class="table-meta">
                <span class="meta-item">
                    ...
                    <?= $this->Paginator->param('count') ?> fornitori
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table data-table-id="fornitori-table">
            <thead>
                <tr>
