...
<div class="anagrafiche form content form-content">
    <div class="page-header">
        <h3><?= __('Modifica Anagrafica') ?>: <?= h($anagrafiche->denominazione ?: $anagrafiche->nome . ' ' . $anagrafiche->cognome) ?></h3>
            ...
            <div class="form-row">
                <div class="form-col-third">
                    <?= $this->Form->control('tipo', [
                        'type' => 'select',
                        'options' => $tipiAnagrafica,
                        'label' => ['text' => 'Tipo', 'class' => 'required'],
                        'class' => 'form-control'
                    ]) ?>
                </div>
                <div class="form-col">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-col-quarter">
                    <?= $this->Form->control('nazione', ['label' => 'Nazione', 'placeholder' => 'IT']) ?>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="form-actions">
                <div class="btn-group-left">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            'confirm' => __('Sei sicuro di voler eliminare {0}?', $anagrafiche->denominazione ?: $anagrafiche->nome),
