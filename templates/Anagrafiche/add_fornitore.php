...
<div class="anagrafiche form content form-content">
    ...
    <?= $this->Form->hidden('tipo', ['value' => 'fornitore']) ?>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            Dati Principali
            <span class="badge bg-info ms-2">Fornitore</span>
        </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-actions">
                <div class="btn-group-left">
                    <?= $this->Html->link(__('Annulla'), ['action' => 'indexFornitori'], ['class' => 'btn btn-secondary']) ?>
                </div>
