...
<div class="tenants form content form-content">
    <div class="page-header">
        <h3><?= __('Modifica Tenant') ?>: <?= h($tenant->nome) ?></h3>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="form-row">
                <div class="form-col">
                    <?= $this->Form->control('nome', ['label' => ['text' => 'Nome / Ragione Sociale', 'class' => 'required']]) ?>
                </div>
            ...
            <div class="form-row">
                <div class="form-col-half">
                    <?= $this->Form->control('partita_iva', ['label' => 'Partita IVA']) ?>
                </div>
                <div class="form-col-half">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="form-row">
                <div class="form-col-full">
                    <?= $this->Form->control('indirizzo', ['label' => 'Indirizzo']) ?>
                </div>
            </div>
            <div class="form-row">
                <div class="form-col">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="form-row">
                <div class="form-col-half">
                    <?= $this->Form->control('sito_web', ['label' => 'Sito Web']) ?>
                </div>
                <div class="form-col-half">
                    <?= $this->Form->control('slug', ['label' => 'Slug']) ?>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="form-actions">
                <div class="btn-group-left">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        ['confirm' => __('Sei sicuro di voler eliminare {0}?', $tenant->nome), 'class' => 'btn btn-danger', 'escapeTitle' => false]
                    ) ?>
                </div>
